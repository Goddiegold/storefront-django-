# Generated by Django 4.1.5 on 2023-01-05 14:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(choices=[('B', 'Bronze'), ('S', 'Silver'), ('G', 'Gold')], default='B', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('payment_stauts', models.CharField(choices=[('P', 'Pending'), ('C', 'Complete'), ('F', 'Failed')], default='P', max_length=1)),
